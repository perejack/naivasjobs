...
import { ArrowLeft, Mail, MapPin, Clock, Send, Building } from "lucide-react";
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">emmanuelkiprotich.dr@gmail.com</p>
