          ...
          <div className="space-y-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">209 Lenana Road, Nairobi, Kenya</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Contact Phone</p>
                    <p className="font-semibold">+254 105 575 260</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Website</p>
                    <p className="font-semibold">https://www.naivasjobs.site/</p>
                  </div>
                  <div>
            ...
            <section>
              ...
              <div className="bg-muted/50 rounded-lg p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://www.naivasjobs.site/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    https://www.naivasjobs.site/
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+254105575260" className="text-primary hover:underline">
                    +254 105 575 260
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-muted-foreground">Address: 209 Lenana Road, Nairobi, Kenya</span>
                </div>
              </div>
            </section>
            ...
            <section className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-sm text-yellow-700">
                ...
                and asks for money through other means, please report immediately by contacting us at{" "}
                <a href="tel:+254105575260" className="underline">
                  +254 105 575 260
                </a>.
              </p>
            </section>
