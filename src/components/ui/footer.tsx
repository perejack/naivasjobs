...
import { Phone, MapPin, Shield, FileText, HelpCircle, MessageSquare, Globe, Info } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>209 Lenana Road, Nairobi, Kenya</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" />
                <span>+254 105 575 260</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Globe className="h-4 w-4" />
                <a href="https://www.naivasjobs.site/" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                  www.naivasjobs.site
                </a>
              </div>
            </div>
        ...
        <div className="border-t pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-muted-foreground">
              ...
              <span>•</span>
              <span>209 Lenana Road, Nairobi</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-muted rounded-lg">
          <p className="text-xs text-muted-foreground text-center">
            ...
            For any concerns or complaints, please contact our support team at +254 105 575 260
          </p>
        </div>
      </div>
    </footer>
